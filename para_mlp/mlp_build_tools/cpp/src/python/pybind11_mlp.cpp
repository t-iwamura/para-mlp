...
PYBIND11_MODULE(mlpcpp, m) {
    ...
    py::class_<ModelPy>(m, "PotentialModel")
        .def(py::init<const vector3d&,const vector3d&,const vector2i&,
                const int&, const bool&,const vector2d&,const double&,
                const std::string&,const std::string&,const int&,const int&,
                const int&,const vector3i&,const vector2i&,const vector2d&,
                const vector1i&,const std::vector<bool>&,const vector1i&,
                const bool&>())
    ...
    py::class_<ModelSinglePy>(m, "PotentialModelSingle")
        .def(py::init<const vector2d&,const vector2d&,const vector1i&,
                const int&, const bool&,const vector2d&,const double&,
                const std::string&,const std::string&,const int&,const int&,
                const int&,const vector3i&,const vector2i&,const vector2d&>())
        .def("get_x", &ModelSinglePy::get_x,
                py::return_value_policy::reference_internal)
        //.def("compute", &ModelSinglePy::compute,
        //        py::return_value_policy::reference_internal)
        ;


    py::class_<Readgtinv>(m, "Readgtinv")
        .def(py::init<const int&, const vector1i&,
    ...
    py::class_<Ewald>(m, "Ewald")
        .def(py::init<const vector2d&,const vector2d&,const vector1i&,
                const int&,const double&,const vector2d&,const vector1d&,
