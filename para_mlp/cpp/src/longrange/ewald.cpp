...
double Ewald::realspace
(const vector3d& dis_array, const vector3i& atom2_array){
...
double Ewald::reciprocal
(const vector2d& gvectors, const vector2d& positions_c, 
 const double& volume){
...
double Ewald::reciprocal_f
(const vector2d& gvectors, const vector2d& positions_c, 
 const double& volume, arma::vec& fg, arma::vec& sg){
...
//            diff[atom1][atom2] = arma::vec(positions_c[atom2]) 
 //               - arma::vec(positions_c[atom1]);
        }
    }
    return diff;
}
